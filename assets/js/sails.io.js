    ...
    function SailsIOClient(io) {
        ...
        function SailsSocket(opts) {
            ...
            self.on('sails:parseError', function(err) {
                consolog('Server encountered an error parsing a socket message sent from this client, and did not have access to a callback function to respond with.');
            ...
            (function selfInvoking(cb) {
                ...
                self.on('connect', function socketConnected() {
                    ...
                    consolog.noPrefix(
                        ...
                        // '  \\___/  '+️
                        // '\n'+
                        'Socket now connected to the server.'
                        // '\\___/   For help, see: http://bit.ly/1DmTvgK' + '\n' +
                        // '\\___/        (using ' + io.sails.sdk.platform + ' SDK @v' + io.sails.sdk.version + ')' + '\n' +
                        // '\n' +
                        // '\n' +
                        // '\n'+
                        // ''
                ...
                self.on('disconnect', function() {
                    ...
                    // consolog('====================================');
                    consolog('Socket was disconnected from the server.');
                ...
                self.on('reconnecting', function(numAttempts) {
                    consolog(
                        // '\n' +
                        'Socket is trying to reconnect to the server...\n'
                ...
                self.on('reconnect', function(transport, numAttempts) {
                    ...
                    consolog(
                        ...
                        // 'being offline for ~' + numSecsOffline + ' seconds.' + '\n' +
                        // '\n'
                    );
                });
        ...
        io.sails.connect = function(url, opts) {
            ...
            io.socket = new SailsSocket(opts);
            io.socket._connect();
            return io.socket;
        };
